...
public class BasicParticle  {
	...
	public BasicParticle(Vec2 spawnPosition, float radius, Color color, float mass, float linearDragForce) {
		this(spawnPosition.x, spawnPosition.y, 0, 0, radius, color, mass, linearDragForce);
	}
