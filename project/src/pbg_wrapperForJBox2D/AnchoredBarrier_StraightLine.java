...
public class AnchoredBarrier_StraightLine extends AnchoredBarrier {
	...
	public AnchoredBarrier_StraightLine(Vec2 startPosition, Vec2 endPosition, Color color)
	{
		this(startPosition.x, startPosition.y, endPosition.x, endPosition.y, color);
	}
